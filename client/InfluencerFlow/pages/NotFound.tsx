...
export function NotFound({
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background flex items-center justify-center">
          ...
          {/* <div className="flex-1 absolute opacity-30">
            <SplineScene 
      ...
      <div className="relative text-center z-10 px-4 max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-pretty text-lg font-medium text-muted-foreground sm:text-xl/8 max-w-2xl mx-auto">
          {description}
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-4">
          ...
          <HoverBorderGradient
            ...
            as="button"
            className="bg-white text-black dark:bg-white dark:text-black flex items-center justify-center px-6 py-3 text-base font-medium group"
